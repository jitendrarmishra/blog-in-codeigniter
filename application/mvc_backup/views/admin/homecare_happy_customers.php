...
if ($edit != "") {
    ...
    $validation = '';
    $edit = site_url() . "/admin/home/update_homecare_happy_customers";
} else {
    $customer_id = "";
    $homecare_product_id = "";
    $status = "";
    ...
    $banner = "";
    $validation = 'required';
    $edit = site_url() . "/admin/home/add_homecare_happy_customers";
}
?>
...
<div class="main-content">
    <div class="main-content-inner">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="header smaller lighter blue">Add/Update Homecare Happy Customers</h3>
                ...
                <form enctype="multipart/form-data" id="myform" data-parsley-validate="" class="form-horizontal" role="form" method="post" action="<?php echo $edit ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select required="" class="form-control col-xs-10 col-sm-5" name="homecare_product_id" id="form-field-select-1">
                                <option value="">Select Homecare Product</option>
                                <?php foreach ($homecare_product as $row) { ?>
                                    <option <?php echo $homecare_product_id == $row->homecare_product_id ? "selected" : "" ?> value="<?php echo $row->homecare_product_id ?>"><?php echo $row->black_text ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="<?php echo site_url(); ?>admin/home/homecare_happy_customers/<?php echo base64_encode($row->customer_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_homecare_happy_customers/<?php echo base64_encode($row->customer_id); ?>/<?php echo base64_encode($row->photo); ?>">
