<?php
if ($edit != "") {
    $homecare_concern_id = $edit->homecare_concern_id;
    $homecare_concern_name = $edit->homecare_concern_name;
    $text = $edit->text;
    $homecare_concern_status = $edit->homecare_concern_status;
    $banner = $edit->banner;
    ...
    $btext = $edit->btext;
    $validation = '';
    $edit = site_url() . "admin/home/update_homecare_concern";
} else {
    $homecare_concern_id = "";
    $homecare_concern_name = "";
    $text = "";
    $homecare_concern_status = "";
    $banner = "";
    $meta_title = "";
    $meta_description = "";
    $meta_keyword = "";
    $btext = "";
    $validation = 'required';
    $edit = site_url() . "admin/home/add_homecare_concern";
}
?>
...
<div class="main-content">
    <div class="main-content-inner">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="header smaller lighter blue">Add/Update Homecare Concern</h3>
                ...
                <form enctype="multipart/form-data" id="myform" data-parsley-validate="" class="form-horizontal" role="form" method="post" action="<?php echo $edit ?>">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Concern Title</label>

                        <div class="col-sm-9">
                            <input required="" type="text" id="concern_slug" name="homecare_concern_name" onblur="check('homecare_concern','concern_slug',this.id,'Concern')" value="<?php echo $homecare_concern_name ?>" placeholder="" class="col-xs-10 col-sm-5" />
                            <span id="errmsg"></span>
                            <input required="" type="hidden" id="form-field-1" name="homecare_concern_id" value="<?php echo $homecare_concern_id ?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select required="" class="form-control col-xs-10 col-sm-5" name="status" id="form-field-select-1">
                                <option value=""></option>
                                <option <?php echo $homecare_concern_status == 'active' ? "selected" : "" ?> value="active">Active</option>
                                <option <?php echo $homecare_concern_status == 'inactive' ? "selected" : "" ?> value="inactive">inactive</option>
                            </select>
                        </div>
                    </div>
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    ...
                                    <tr role="row" class="odd">
                                        <td><?php echo $row->homecare_concern_name ?></td>

                                        <td><img height="100" width="200" src="<?php echo base_url() ?>uploads/homecare/<?php echo $row->banner ?>"></td>
                                        <td><?php echo $row->homecare_concern_status ?></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="<?php echo site_url(); ?>admin/home/homecare_concern/<?php echo base64_encode($row->homecare_concern_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_homecare_concern/<?php echo base64_encode($row->homecare_concern_id); ?>/<?php echo base64_encode($row->banner); ?>">
