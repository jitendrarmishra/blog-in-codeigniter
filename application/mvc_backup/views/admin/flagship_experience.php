<?php
if ($edit != "") {
    $flagship_experience_id = $edit->flagship_experience_id;
    $text = $edit->text;
    $image = $edit->image;
    $status = $edit->status;
    $validation = '';
    $edit = site_url() . "admin/home/update_flagship_experience";
} else {
    $flagship_experience_id = "";
    $text = "";
    $image = "";
    $status = "";
    $validation = 'required';
    $edit = site_url() . "admin/home/add_flagship_experience";
}
?>
...
<div class="main-content">
    <div class="main-content-inner">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="header smaller lighter blue">Add/Update Flagship Experience</h3>
                ...
                <form enctype="multipart/form-data" id="myform" data-parsley-validate="" class="form-horizontal" role="form" method="post" action="<?php echo $edit ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required="" type="hidden" id="form-field-1" name="flagship_experience_id" value="<?php echo $flagship_experience_id ?>"/>
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <a class="green" href="<?php echo site_url(); ?>admin/home/flagship_experience/<?php echo base64_encode($row->flagship_experience_id); ?>">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_flagship_experience/<?php echo base64_encode($row->flagship_experience_id); ?>/<?php echo base64_encode($row->image); ?>">
