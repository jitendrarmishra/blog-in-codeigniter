...
//    $meta_keyword = $edit->meta_keyword;
    $edit = site_url() . "/admin/home/update_expert_faq";
} else {
    $faq_id = "";
    $faq_q = "";
    $faq_ans = "";
...
//    $meta_description = "";
//    $meta_keyword = "";
    $edit = site_url() . "/admin/home/add_expert_faq";
}
?>
            ...
            <div class="col-xs-12">
                ...
                <form id="myform" data-parsley-validate="" class="form-horizontal" role="form" method="post" action="<?php echo $edit ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea required="" style="height: 150px; width: 600px" class=" col-xs-10 col-sm-5" name="faq_q"><?php echo $faq_q ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea required="" style="height: 150px; width: 600px" class=" col-xs-10 col-sm-5" name="faq_ans"><?php echo $faq_ans ?></textarea>
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td><?php echo ucfirst($row->faq_status) ?></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="<?php echo site_url(); ?>admin/home/expert_faq/<?php echo base64_encode($row->faq_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a> 
                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_expert_faq/<?php echo base64_encode($row->faq_id); ?>">
