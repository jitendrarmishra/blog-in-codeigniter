            ...
            <div class="col-xs-12">
                ...
                <form enctype="multipart/form-data" id="myform" data-parsley-validate="" class="form-horizontal" role="form" method="post" action="<?php echo $edit ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input required="" type="text" id="form-field-1" readonly="" name="user_name" value="<?php echo $user_name ?>" placeholder="" class="col-xs-10 col-sm-5" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea required="" style="width:600px;height: 150px" class=" col-xs-10 col-sm-5" name="comment"><?php echo $comment ?></textarea>
                        </div>
                    </div>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="<?php echo site_url(); ?>admin/home/blog_comments/<?php echo base64_encode($row->comment_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>
                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_blog_comments/<?php echo base64_encode($row->comment_id); ?>">
