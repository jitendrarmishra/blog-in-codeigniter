...
//die;
if ($edit != "") {
    $ingredients_id = $edit->ingredients_id;
    $text = $edit->text;
    $title = $edit->title;
//    $banner = $edit->banner;
    $step_status = $edit->ingredients_status;
    $validation = "";
    $edit = site_url() . "admin/home/update_concern_ingredients";
} else {
    $ingredients_id = "";
    $text = "";
    $title = "";
//    $banner = "";
    $step_status = "";
    $validation = "required";
    $edit = site_url() . "admin/home/add_concern_ingredients";
}
?>
...
<div class="main-content">
    <div class="main-content-inner">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="header smaller lighter blue">Add/Update Concern Ingredients</h3>
...
<!--                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required="" type="hidden" id="form-field-1" name="ingredients_id" value="<?php echo $ingredients_id ?>"/>
                            <input required="" type="hidden" id="form-field-1" name="concern_product_inner_id" value="<?php echo $product_id ?>"/>
                        </div>
                    </div>
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    ...
                                    <tr role="row" class="odd">
                                        <td><?php echo $row->inner_title ?></a></td>
                                        <td><?php echo $row->title ?></a></td>
                                        <td><?php echo $row->text ?></a></td>
                                        <td><?php echo ucfirst($row->ingredients_status) ?></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="<?php echo site_url(); ?>admin/home/concern_ingredients/<?php echo base64_encode($product_id) ?>/<?php echo base64_encode($row->ingredients_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_concern_ingredients/<?php echo base64_encode($product_id) ?>/<?php echo base64_encode($row->ingredients_id); ?>">
