            ...
            <div class="col-xs-12">
                ...
                <form id="myform" data-parsley-validate="" class="form-horizontal" role="form" method="post" action="<?php echo $edit ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input required="" type="text" id="category_slug" onblur="check('blog_category','category_slug',this.id,'Category')" name="title" value="<?php echo $concern_name ?>" placeholder="Category" class="col-xs-10 col-sm-5" />
                            <span id="errmsg"></span>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="<?php echo site_url(); ?>admin/home/category/<?php echo base64_encode($row->category_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_category/<?php echo base64_encode($row->category_id); ?>">
