...
if ($edit != "") {
    ...
    $edit = site_url() . "/admin/home/update_homecare_faq";
} else {
    $faq_id = "";
    $faq_q = "";
    $faq_ans = "";
    ...
    $edit = site_url() . "/admin/home/add_homecare_faq";
}
?>
...
<div class="main-content">
    <div class="main-content-inner">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="header smaller lighter blue">Add/Update Homecare FAQ</h3>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="<?php echo site_url(); ?>admin/home/homecare_faq/<?php echo base64_encode($product_id) ?>/<?php echo base64_encode($row->faq_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_homecare_faq/<?php echo base64_encode($product_id) ?>/<?php echo base64_encode($row->faq_id); ?>">
