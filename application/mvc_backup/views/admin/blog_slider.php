                    ...
                    <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" aria-label="Domain: activate to sort column ascending">Post Title</th>
                                
                                <th class="sorting_disabled" rowspan="1" colspan="1" aria-label="">Image</th>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="<?php echo site_url(); ?>admin/home/blog_slider/<?php echo base64_encode($row->blog_slider_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_blog_slider/<?php echo base64_encode($row->blog_slider_id); ?>/<?php echo base64_encode($row->image); ?>">
