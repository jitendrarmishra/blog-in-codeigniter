...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login Page - Cherly's Admin</title>
        ...
        <!-- ace styles -->
        <link rel="stylesheet" href="<?php echo $this->config->item('assets'); ?>assets/css/ace.min.css" />
                                                ...
                                                <fieldset>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            ...
                                                            <input class="form-control" tabindex="1" autocomplete="off" placeholder="Username"  name="email" id="username" type="text">
...
<![endif]-->
        <script type="text/javascript">
            if ('ontouchstart' in document.documentElement)
                document.write("<script src='<?php echo $this->config->item('assets'); ?>assets/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
        </script>
