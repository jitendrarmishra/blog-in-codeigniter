...
//    $banner = $edit->banner;
    ...
    $validation = "";
    $edit = site_url() . "/admin/home/update_ingredients";
} else {
    $ingredients_id = "";
    $text = "";
    $title = "";
//    $banner = "";
    $step_status = "";
    $validation = "required";
    $edit = site_url() . "/admin/home/add_ingredients";
}
?>
...
<div class="main-content">
    <div class="main-content-inner">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="header smaller lighter blue">Add/Update Ingredients</h3>
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="<?php echo site_url(); ?>admin/home/ingredients/<?php echo base64_encode($product_id) ?>/<?php echo base64_encode($row->ingredients_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_ingredients/<?php echo base64_encode($product_id) ?>/<?php echo base64_encode($row->ingredients_id); ?>">
