                    ...
                    <form enctype="multipart/form-data" id="myform" data-parsley-validate="" class="form-horizontal" role="form" method="post" action="<?php echo $edit ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input required="" type="hidden" id="form-field-1" name="type" value="<?php echo 'insta_wow' ?>"/>
                                <input required="" type="hidden" id="form-field-1" name="redirect" value="<?php echo 'business_insta_wow' ?>"/>
                            </div>
                        </div>
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <a class="green" href="<?php echo site_url(); ?>admin/home/business_insta_wow/<?php echo base64_encode($row->business_support_slider_id); ?>">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                            </a>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_business_support_slider/<?php echo base64_encode($row->business_support_slider_id); ?>/<?php echo base64_encode($row->business_support_photos); ?>/<?php echo base64_encode('business_insta_wow'); ?>">
