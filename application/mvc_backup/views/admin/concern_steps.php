...
if ($edit != "") {
    ...
    $edit = site_url() . "/admin/home/update_concern_steps";
} else {
    $step_id = "";
    $text = "";
    $step_status = "";

    $edit = site_url() . "/admin/home/add_concern_steps";
}
?>
...
<div class="main-content">
    <div class="main-content-inner">
        <div class="row">
            <div class="col-xs-12">
                <h3 class="header smaller lighter blue">Add/Update Concern Steps</h3>
                            ...
                            if ($result) {
                                foreach ($result as $row) {
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td><?php echo ucfirst($row->step_status) ?></td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green" href="<?php echo site_url(); ?>admin/home/concern_steps/<?php echo base64_encode($product_id) ?>/<?php echo base64_encode($row->step_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_concern_steps/<?php echo base64_encode($product_id) ?>/<?php echo base64_encode($row->step_id); ?>">
