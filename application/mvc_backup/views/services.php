<div data-stellar-background-ratio="0.5" style="background: url(<?php echo base_url() ?>uploads/services/<?php echo $salon_category->banner ?>) no-repeat;height:100vh;background-size:cover;" class="service_box1 posr grid-100 mobile-grid-100 tablet-grid-100">
    <div class="bullet_box animate_left hide-on-mobile hide-on-tablet">
        <a class="bullet_text" href="<?php echo base_url() ?>">Home</a> > <span class="bullet_text"><?php echo ucfirst($salon_category->service_name) ?></span>
    </div>
    <div class="service_box1_sub parallax">
        <h1 class="service_box1_text1 animate_left"><?php echo ucfirst($salon_category->service_name) ?></h1>
        <p class="service_box1_text2 animate_bottom"><?php echo ucfirst($salon_category->text) ?></p>
...
<div class="service_box2 grid-100 mobile-grid-100 tablet-grid-100">
    <div class="grid-container">
                ...
                foreach ($products as $row) {
                    ...
                    <div class="service_offered_box pad0 grid-100 mobile-grid-100 tablet-grid-100">
                        ...
                        <div class="service_offer_sub1 grid-55 mobile-grid-100 tablet-grid-50">
                            ...
                            <div class="wdh animate_bottom"><a class="slider_a bb_pd" style="float:none;" href="<?php echo base_url() ?>salon-category/<?php echo $salon_category->services_slug ?>/<?php echo $row->product_slug?>">KNOW MORE</a></div>
                        </div>      
                    </div>
        ...
        <div id="go_down" class="grid-90 prefix-5 mobile-grid-100 tablet-grid-100">
            <p  class="box2_text2 animate_bottom"><?php echo ucfirst($salon_category->btext) ?></p>
