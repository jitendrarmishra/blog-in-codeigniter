...
<script type="application/ld+json">
    ...
    "image": [
    "<?php echo base_url() ?>uploads/homecare/<?php echo $product->banner_image ?>"

    ],
    "description": "<?php echo $product->short_text ?>",
    ...
    "@type": "Offer",
    "priceCurrency": "INR",
    "price": "<?php echo $product->homecare_product_cost ?>"
...
<div class="container">
    ...
    <div class="homecare_inner_box2 grid-100 mobile-grid-100 tablet-grid-100">
        <div class="grid-container">
            <?php if (!empty($benefits)) { ?>
                <div class="benefit_box homecare_mrg_btm grid-100 mobile-grid-100 tablet-grid-100">
                    ...
                    foreach ($benefits as $row) {
                        ?>
                        <div class="homecare_push_left grid-30 mobile-grid-100 tablet-grid-50">
            ...
            <?php if (!empty($ingredients_photo)) { ?>
                    ...
                    <div class="indulge_info_box posr grid-100 mobile-grid-100 tablet-grid-100">
                        <div class="indulge_tab_box grid-80 mobile-grid-100 tablet-grid-80">
                            ...
                            foreach ($steps as $row) {
                                ...
                                <a class="indulge_tab_a indulge_tab_a_active" href="javascript:void(0);" data-related="step_<?php echo $i ?>"> <?php echo "Step" . $i ?> : <?php echo $row->step_title ?> <span class="indulge_tab_span "></span></a>
                        ...
                        foreach ($steps as $row) {
                            ?>
                            <div class="pad0 grid-100 mobile-grid-100 tablet-grid-100 benefit-steps" id="step_<?php echo $i ?>">
