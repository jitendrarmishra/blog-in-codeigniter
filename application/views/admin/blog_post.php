            ...
            <div class="col-xs-12">
                ...
                <form enctype="multipart/form-data" id="myform" data-parsley-validate="" class="form-horizontal" role="form" method="post" action="<?php echo $edit ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input required="" type="text" id="post_slug" onblur="check('blog_post', 'post_slug', this.id, 'Post title ')" name="post_title" value="<?php echo $post_title ?>" class="form-control col-xs-10 col-sm-5" />
                            <span id="errmsg"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="ckeditor form-controll col-xs-10 col-sm-12" style="height: 150px;" name="post_text"><?php echo $post_text ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea id="hghjhg" style="height: 150px;" class="form-control col-xs-10 col-sm-5" name="meta_title"><?php echo $meta_title ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea id="hghjhg" style="height: 150px;" class="form-control col-xs-10 col-sm-5" name="meta_description"><?php echo $meta_description ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea id="hghjhg" style="height: 150px;" class="form-control col-xs-10 col-sm-5" name="meta_keyword"><?php echo $meta_keyword ?></textarea>
                        </div>
                    </div>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                                ...
                                                <a class="green btn" href="<?php echo site_url(); ?>admin/home/blog_posts/<?php echo base64_encode($row->post_id); ?>">
                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                </a>

                                                <a class="btn delete" onclick="return confirm('Are you sure want to delete?')" class="red" href="<?php echo site_url(); ?>admin/home/delete_blog_posts/<?php echo base64_encode($row->post_id); ?>/<?php echo base64_encode($row->image); ?>">
