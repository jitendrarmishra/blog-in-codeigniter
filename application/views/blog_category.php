...
<div style="width:100%;" class="bullet_box blog_tp animate_left hide-on-mobile hide-on-tablet">
        <p style="text-align:left;"><a class="bullet_text bt_mrg" href="<?php echo base_url(); ?>">Home</a> > <a class="bullet_text bt_mrg" href="<?php echo base_url(); ?>blog/category/<?php echo @$category_name ?>"><?php echo ucfirst($category_data->category_name); ?></p>
    </div>

    <div class="grid-container mob_pad0">

        <div style="margin-bottom:5%; margin-top:13%;" class="blog_container mob_pad0 mob_bc grid-100 mobile-grid-100 tablet-grid-100">
                        ...
                        <div class="grid-33 mobile-grid-100 tablet-grid-33">
                            <div class="blog_info_box pad0 posr grid-100 mobile-grid-100 tablet-grid-100">
                                <div class="blog_share_box">
                                    <div class="blog_share_sub">
                                        <div class="blog_share_width-box">
                                            ...
                                            <a class="blog_share_icons st-custom-button hide-on-desktop" data-network="whatsapp" data-title="<?php echo $row->post_title ?>" href="javascript:void(0);"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
                                ...
                                <div class="service_offer_sub1 grid-100 mobile-grid-100 tablet-grid-100">
                                    ...
                                    <div class="wdh animate_bottom"><a class="slider_a bb_pd2" style="float:none;" href="<?php echo base_url() ?>blog/<?php echo $row->category_slug ?>/<?php echo $row->post_slug ?>">READ MORE</a></div>
                                </div>
                            </div>
                        </div>
                        <?php
